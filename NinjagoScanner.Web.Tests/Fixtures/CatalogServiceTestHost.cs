...
/// loopback port, backed by a temp directory of catalog JSON files, so tests can point the Web
/// app's gRPC-calling logic at a real gRPC endpoint without a separately-run process.
/// </summary>
