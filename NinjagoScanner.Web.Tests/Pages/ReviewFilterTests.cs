...
public sealed class ReviewFilterTests
{
    ...
    private static CardListItem Photo(string photoId, string reviewStatus = ReviewStatuses.Unreviewed, string analysisStatus = AnalysisStatuses.Ok, string? cardName = null, string? cardNumber = null) => new()
    {
        PhotoId = photoId,
    ...
    {
        var group = Group(
            Photo("a", reviewStatus: ReviewStatuses.Unreviewed, analysisStatus: AnalysisStatuses.Uncertain, cardName: "Kai", cardNumber: "4"),
            Photo("b", reviewStatus: ReviewStatuses.Verified, analysisStatus: AnalysisStatuses.Ok, cardName: "Zane", cardNumber: "10"));
