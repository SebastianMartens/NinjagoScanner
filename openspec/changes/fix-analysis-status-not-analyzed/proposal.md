...
- `NinjagoScanner.PictureService/Services/PictureScannerGrpcService.cs` — `ToCardEntry` gains a shared normalization helper; the four `UpdateXxx` create-if-missing fallbacks drop the explicit status literal.
